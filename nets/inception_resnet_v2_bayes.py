...
def inception_resnet_v2_base(inputs,
  ...
  with tf.variable_scope(scope, 'InceptionResnetV2', [inputs]):
    with slim.arg_scope([slim.conv2d, bayes_conv2d, slim.max_pool2d, slim.avg_pool2d],
...
def inception_resnet_v2_bayes(inputs, num_classes=1001, is_training=True,
...
inception_resnet_v2_bayes.default_image_size = 299


def inception_resnet_v2_arg_scope_bayes(weight_decay=0.00004,
